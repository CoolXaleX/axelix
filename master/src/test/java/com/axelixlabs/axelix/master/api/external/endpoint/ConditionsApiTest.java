 ...
 */
class ConditionsApiTest extends AbstractProtectedEndpointTest {
    ...
    protected Set<TestableMasterWebEndpoint> endpointsUnderTest() {
        return Set.of(new TestableMasterWebEndpoint(
                MasterWebEndpoints.CONDITIONS_READ,
                "/api/external/conditions/feed/00000000-0000-0000-0000-000000000001"));
    }
}
