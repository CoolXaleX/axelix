 ...
 */
public class MetricsApiTest extends AbstractProtectedEndpointTest {
...
""";
    ...
    protected Set<TestableMasterWebEndpoint> endpointsUnderTest() {
        return Set.of(new TestableMasterWebEndpoint(
                MasterWebEndpoints.METRICS_READ, "/api/external/metrics/00000000-0000-0000-0000-000000000001"));
    }
}
