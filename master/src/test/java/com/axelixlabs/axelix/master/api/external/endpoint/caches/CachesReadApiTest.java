 ...
 */
public class CachesReadApiTest extends AbstractProtectedEndpointTest {
    ...
    void shouldReturnBadRequestForUnregisteredInstanceCachesResponse() {
        ...
        ResponseEntity<String> response =
                restTemplate.asViewer().getForEntity("/api/external/caches/{instanceId}", String.class, instanceId);
    ...
    protected Set<TestableMasterWebEndpoint> endpointsUnderTest() {
        return Set.of(
                new TestableMasterWebEndpoint(
                        MasterWebEndpoints.CACHES_READ, "/api/external/caches/00000000-0000-0000-0000-000000000001"),
                new TestableMasterWebEndpoint(
                        MasterWebEndpoints.CACHE_READ_ONE,
                        "/api/external/caches/00000000-0000-0000-0000-000000000001/cache/cities?cacheManager=cacheManager"));
    }
}
