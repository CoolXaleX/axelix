 ...
 */
public class ConfigPropsApiTest extends AbstractProtectedEndpointTest {
    // language=json
    ...
    protected Set<TestableMasterWebEndpoint> endpointsUnderTest() {
        return Set.of(new TestableMasterWebEndpoint(
                MasterWebEndpoints.CONFIG_PROPS_READ,
                "/api/external/configprops/feed/00000000-0000-0000-0000-000000000001"));
    }
}
