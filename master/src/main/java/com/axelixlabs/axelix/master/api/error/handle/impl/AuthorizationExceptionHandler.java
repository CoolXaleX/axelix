 ...
 */
@Component
public class AuthorizationExceptionHandler extends AbstractExceptionHandler<AuthorizationException> {

    protected AuthorizationExceptionHandler(List<OnWebIamEventInterceptor> interceptors) {
        super(interceptors);
    }

    @Override
    public ApiError handle(HttpServletRequest request, AuthorizationException exception) {
