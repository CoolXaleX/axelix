...
public final class MasterWebEndpoints {
    ...
    // MCP OAUTH2
    public static final MasterWebEndpoint MCP_OIDC_METADATA = register(
            "mcp-tools:oidc:metadata", HttpMethod.GET, ApiPaths.McpOAuth2Api.PROTECTED_RESOURCE_METADATA, null);
