 ...
 */
public class BadAuthorityTestExecutionCallback implements BeforeTestExecutionCallback {

    private final Authority noAccessAuthority;
    private final String path;
    private final String method;

    public BadAuthorityTestExecutionCallback(Authority noAccessAuthority, String path, String method) {
        this.noAccessAuthority = noAccessAuthority;
        this.path = path;
        this.method = method;
    }
    ...
    public void beforeTestExecution(ExtensionContext context) {
        ...
        TestRestTemplate integrationTestsRole =
                testRestTemplateBuilder.withRole(new DefaultRole("INTEGRATION_TESTS_ROLE", Set.of(noAccessAuthority)));

        ResponseEntity<Void> result = integrationTestsRole.exchange(
                path, org.springframework.http.HttpMethod.valueOf(method), null, Void.class);
