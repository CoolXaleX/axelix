 ...
 * problems detected in their association mappings. The concrete implementation is expected to be contributed
 * by a given starter.
 *
 * @author Mikhail Polivakha
 */
public interface JpaEntitiesProfileProvider {

    /**
     * @return the map of mapped entities discovered for the current instance.
     */
    JpaEntities getEntities();
}
