...
class DefaultAuthorityResolverTest {
    ...
    private static Stream<Arguments> pathsAvailableToEveryone() {
        return Stream.of(
                ...
                Arguments.of("/axelix-loggers/group/{name}", HttpMethod.GET),
                Arguments.of("/axelix-loggers/logger/{name}/change-level", HttpMethod.POST),
                Arguments.of("/axelix-loggers/group/{name}/change-level", HttpMethod.POST),
                Arguments.of("/axelix-loggers/logger/{name}/reset", HttpMethod.POST),
