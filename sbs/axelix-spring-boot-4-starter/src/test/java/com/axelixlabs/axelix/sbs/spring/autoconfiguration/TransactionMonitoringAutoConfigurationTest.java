...
class TransactionMonitoringAutoConfigurationTest {
    ...
    void shouldActivateLog4j2Configuration_whenLog4j2IsTheDetectedLoggingSystemBySpringBoot() {
        ...
        contextRunner
                ...
                .withBean(
                        LoggingSystem.class,
                        // Log4J2LoggingSystem's constructor is package-private as of Spring Boot 4; this test is
                        // disabled anyway, so a mock is enough to keep it compiling.
                        () -> Mockito.mock(Log4J2LoggingSystem.class))
                .run(context -> {
                    assertThat(context).doesNotHaveBean(LogbackInMemoryPaginationAppenderConfiguration.class);
