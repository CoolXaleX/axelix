...
/**
 * Auto-Configuration for registering {@link BuildGitInfoProperties}.
 *
 ...
 */
@AutoConfiguration
public class AxelixBuildGitInfoPropertiesAutoConfiguration {

    @Bean
    public BuildGitInfoProperties buildGitInfoProperties(@Value(AXELIX_INFO_LOCATION) Resource axelixInfoResource) {
        BuildGitInfoProperties emptyProperties = BuildGitInfoPropertiesLoader.empty();
